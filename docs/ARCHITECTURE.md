...
Forward provenance records the original author separately from the person who
forwarded a message into the current chat. Fields are null for messages that
were not forwarded, or when Telegram does not disclose the original source.
