...
> Privacy: Telegram exports contain personal data. Import them through LifeQuery's
> UI or a local, ignored directory such as `exports/`; never place an export in
> the repository or commit it to Git.
